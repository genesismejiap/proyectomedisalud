    ...
    public function run(): void
    {
        ...
        if ($this->isPostBack()) {
            $PayPalOrder = new \Utilities\Paypal\PayPalOrder(
                "test" . time(),
                "http://localhost/proyectonuevo/proyectomedisalud/index.php?page=Checkout_Error",
                "http://localhost/proyectonuevo/proyectomedisalud/index.php?page=Checkout_Accept"
            );
